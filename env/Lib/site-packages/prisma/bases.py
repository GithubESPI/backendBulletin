...
class BaseAuthenticator(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Authenticator']] = 'Authenticator'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.AuthenticatorActions[_PrismaModelT]':
        from .client import get_client

        return actions.AuthenticatorActions[_PrismaModelT](client or get_client(), cls)


class BaseConfiguration(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Configuration']] = 'Configuration'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ConfigurationActions[_PrismaModelT]':
        from .client import get_client

        return actions.ConfigurationActions[_PrismaModelT](client or get_client(), cls)
